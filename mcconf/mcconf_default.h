...
#define MCCONF_L_MAX_VOLTAGE			59.0	// Maximum input voltage
#endif
...
#define MCCONF_L_LIM_TEMP_ACCEL_DEC		0.1	// Decrease temperature limits this much during acceleration
#endif
...
#define MCCONF_FOC_OPENLOOP_RPM			500.0	// Openloop RPM (sensorless low speed or when finding index pulse)
#endif
...
#define MCCONF_M_NTC_MOTOR_BETA			4100.0 // Beta value for motor termistor
#endif
